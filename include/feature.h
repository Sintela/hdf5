 ...
 */
#if defined(FEAT_HUGE) && defined(FEAT_EVAL) && ((defined(HAVE_GETTIMEOFDAY) && defined(HAVE_SYS_TIME_H)) || defined(WIN3264))
#define FEAT_PROFILE
#endif
 ...
 */
#if defined(FEAT_NORMAL) && defined(FEAT_EVAL) && ((defined(HAVE_GETTIMEOFDAY) && defined(HAVE_SYS_TIME_H)) || defined(WIN3264))
#define FEAT_RELTIME
#endif
 ...
 */
#if (defined(FEAT_NORMAL) || defined(FEAT_GUI_GTK) || defined(FEAT_ARABIC)) && !defined(FEAT_MBYTE) && VIM_SIZEOF_INT >= 4 && !defined(EBCDIC)
#define FEAT_MBYTE
#endif
...
#define USE_DLOPEN
#endif
#if defined(FEAT_EVAL) && (defined(WIN3264) || ((defined(UNIX) || defined(VMS)) && (defined(USE_DLOPEN) || defined(HAVE_SHL_LOAD))))
#define FEAT_LIBCALL
#endif
 ...
 */
#if defined(FEAT_NORMAL) && defined(FEAT_MENU) && (defined(FEAT_GUI_GTK) || defined(FEAT_GUI_MSWIN) || ((defined(FEAT_GUI_MOTIF) || defined(FEAT_GUI_ATHENA)) && defined(HAVE_XPM)) || defined(FEAT_GUI_PHOTON))
#define FEAT_TOOLBAR
#endif
 ...
 * GUI tabline
 */
#if defined(FEAT_WINDOWS) && defined(FEAT_NORMAL) && (defined(FEAT_GUI_GTK) || (defined(FEAT_GUI_MOTIF) && defined(HAVE_XM_NOTEBOOK_H)) || defined(FEAT_GUI_MAC) || (defined(FEAT_GUI_MSWIN) && (!defined(_MSC_VER) || _MSC_VER > 1020)))
...
#define FEAT_GUI_DIALOG
    ...
    (defined(FEAT_GUI_MOTIF) || defined(FEAT_GUI_ATHENA) || defined(FEAT_GUI_GTK) || defined(FEAT_GUI_MSWIN) || defined(FEAT_GUI_PHOTON) || defined(FEAT_GUI_MAC))
 ...
 *			timestamps.
 */
#if defined(FEAT_NORMAL) && ((defined(HAVE_GETTIMEOFDAY) && defined(HAVE_SYS_TIME_H)) || defined(WIN3264))
...
#endif
#if defined(FEAT_GUI_W32) || defined(FEAT_GUI_MOTIF) || defined(FEAT_GUI_ATHENA) || defined(FEAT_GUI_GTK) || defined(FEAT_GUI_PHOTON)
...
#define FEAT_SIGNS
#if ((defined(FEAT_GUI_MOTIF) || defined(FEAT_GUI_ATHENA)) && defined(HAVE_X11_XPM_H)) || defined(FEAT_GUI_GTK) || (defined(WIN32) && defined(FEAT_GUI))
 ...
 */
#if defined(FEAT_SUN_WORKSHOP) || defined(FEAT_NETBEANS_INTG) || defined(FEAT_BIG)
